...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public void onButtonClickSave(View v) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage("Do you want to save your painting?")
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setView(input)
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        Toast.makeText(MainActivity.this, "Painting saved", Toast.LENGTH_SHORT).show();
                        _impressionistView.savePainting(input.getText().toString());
                    }})
                .setNegativeButton(android.R.string.no, null).show();
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuLineSplatter:
                ...
                return true;
            case R.id.menuText:
                Toast.makeText(this, "Text Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Text);
                return true;
        }
        return false;
    }
